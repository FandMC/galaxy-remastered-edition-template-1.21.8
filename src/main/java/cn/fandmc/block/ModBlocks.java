...
public class ModBlocks {
    ...
    private static Block registerBlock(String name, AbstractBlock.Settings settings) {
        RegistryKey<Block> blockKey = RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(Main.MOD_ID, name));
        Block block = new VerticalSlabBlock(settings.registryKey(blockKey));
        registerBlockItem(name, block);
